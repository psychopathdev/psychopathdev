...
|---|---|
| [`audio-scene-caption-lab`](https://github.com/psychopathdev/audio-scene-caption-lab) | A small sandbox for audio, speech, and visual scene captioning workflows with lightweight metrics and report generation. |
| [`vla-action-grounding-playground`](https://github.com/psychopathdev/vla-action-grounding-playground) | A toy environment for instruction-to-action grounding, action schema design, and VLA-style evaluation traces. |
